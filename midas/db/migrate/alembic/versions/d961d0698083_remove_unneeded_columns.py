...
This script performs data migration to copy data from each column to be deleted into the JSON data
in the "extra" column of the associated table. This is extremely show.

UPDATE 210707: Disabled data migration. If you want it, uncomment the proper lines below.
"""
